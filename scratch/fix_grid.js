...
const filePath = 'c:\\Users\\ACER\\OneDrive\\Desktop\\LAB-003-AI-AVENGERS\\frontend\\src\\components\\DestinationGrid.jsx';
let content = fs.readFileSync(filePath, 'utf8');

// Fix conflict 1
const conflict1Regex = /<<<<<<< HEAD[\s\S]*?=======[\s\S]*?(import React.*?handleCustomSearch = \(\) => \{[\s\S]*?onSelect\(customDest\);\n  };)\n>>>>>>> YashNN/;
content = content.replace(conflict1Regex, (match, group1) => {
...
content = content.replace(conflict2Regex, replacement2);
